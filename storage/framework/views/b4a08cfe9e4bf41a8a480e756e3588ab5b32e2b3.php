<?php echo $__env->make('layouts.includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div id="content" class="content">
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">Employee Registration <small></small><a href="<?php echo URL::to('employees'); ?>" class="btn btn-warning m-r-5 m-b-5">Back to employees</a></h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo Form::open(['action' => 'EmployeesController@store', 'files' => true, 'method' => 'POST', 'name' => 'form-wizard', 'data-parsley-validate' => 'true']); ?>


                                <?php echo $__env->make('employees.form', ['submitButton' => "Save"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
