                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo Form::open(['action' => 'CustomersController@store', 'files' => true, 'method' => 'POST', 'name' => 'form-wizard', 'data-parsley-validate' => 'true']); ?>


                                <?php echo $__env->make('customers.form', ['submitButton' => "Save"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
