...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu media-list pull-right animated fadeInDown">
                            <li class="dropdown-header">Notifications (4)</li>
                           
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="{!! asset('img/user.png') !!}" class="media-object" alt="" /></div>
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs">{!! $user->first_name !!}&nbsp;{!! $user->middle_name !!}&nbsp;{!! $user->last_name !!}</span> <b class="caret"></b>
						</a>
		...
		<!-- end #header -->
	@include('layouts.includes.leftside_bar')